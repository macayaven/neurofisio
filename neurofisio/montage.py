...
TCP_MONTAGE_PAIRS = [
    ...
    ('EEG A1-REF', 'EEG T3-REF'),  ('EEG T3-REF', 'EEG C3-REF'),
    ('EEG C3-REF', 'EEG CZ-REF'),  ('EEG CZ-REF', 'EEG C4-REF'),
    ('EEG C4-REF', 'EEG T4-REF'),  ('EEG T4-REF', 'EEG A2-REF'),
...
def apply_tcp_montage(raw):
    ...
    if any('LE' in ch for ch in available):
        pairs = [
            (a.replace('-REF', '-LE'), b.replace('-REF', '-LE'))
            for a, b in pairs
        ]
